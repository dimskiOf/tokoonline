			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right"><!--features_items-->
					<div class="features_items">
						<h2 class="title text-center">Industrial Safety</h2>
						<?php foreach ($industrial_safety as $m) :?>
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="<?php echo base_url().'/uploads/'.$m->foto_barang ?>" style="width: 150%; height:150px;" />
