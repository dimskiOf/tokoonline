			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Electricaly</h2>
						<div class="col-md-4">
							<?php foreach ($electrical as $m) :?>
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="<?php echo base_url().'/uploads/'.$m->foto_barang ?>" style="width: 80%;" /><br>
								...
								<div class="choose" style="width: 25rem;">
